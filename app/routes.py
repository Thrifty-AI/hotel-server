...
images_urls = {
    ...
    'image_trolley-sales-technique-serving': ['image_trolley-sales-technique-serving.png'], 'image_hybrid-concessions-upselling': ['image_hybrid-concessions-upselling.png'], 'image_coffeetree-transaction-process': ['image_coffeetree-transaction-process.png'], 'image_coffee-tree-order-serving': ['image_coffee-tree-order-serving.png'], 'image_4dx-effects': ['image_4dx-effects.png'], 'image_bill-me-back-office-print': ['image_bill-me-back-office-print.png'], 'image_maximization-chart-coffee-tree': ['image_maximization-chart-coffee-tree.png'], 'image_bill-me-back-office': ['image_bill-me-back-office.png'], 'image_bill-me-back-office-ebill': ['image_bill-me-back-office-ebill.png'], 'image_bill-me-back-office-bills': ['image_bill-me-back-office-bills.png'], 'image_hybrid-concessions-transaction': ['image_hybrid-concessions-transaction.png'], 'image_trolley-sales-technique-transaction': ['image_trolley-sales-technique-transaction.png'], 'image_4dx-locations': ['image_4dx-locations.png'], 'image_cinepolis-junior': ['image_cinepolis-junior.png'], 'image_maximization-chart-concessions': ['image_maximization-chart-concessions.png'], 'image_cinepolis_payment_process': ['image_cinepolis_payment_process.png'], 'image_handwash-process': ['image_handwash-process.png'], 'image_coffeetree-sales-technique': ['image_coffeetree-sales-technique.png'], 'image_cinepolis-concessions-serving': ['image_cinepolis-concessions-serving.png'], 'image_hybrid-concessions-order-serving': ['image_hybrid-concessions-order-serving.png'], 'image_order-of-service-preparation': ['image_order-of-service-preparation.png'], 'image_cinepolis-concessions-sales': ['image_cinepolis-concessions-sales.png'], 'image_trolley-sales-technique': ['image_trolley-sales-technique.png'], 'image_cinepolis-concessions-transaction': ['image_cinepolis-concessions-transaction.png'], 'image_cinepolis_sales_technique': ['image_cinepolis_sales_technique.png'],
               }
